  ...
  return (
    <section id="habilidades" className="pb-10 pt-6 sm:pb-12 sm:pt-8" aria-labelledby="skills-title">
      ...
      <ul className="mt-4 grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {skills.map((skill) => (
          <li key={skill} className="flex min-h-16 items-center justify-center rounded-xl border border-white/10 bg-white/[0.025] px-4 py-4 text-center text-base text-zinc-200 sm:min-h-20 sm:px-5 sm:text-lg lg:py-6 lg:text-xl">
            {skill}
          </li>
        ))}
      </ul>
