      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-[1fr_0.95fr] md:items-start lg:gap-10">
          <div>
            ...
            <h2 id="sobre-mi-title" className="mt-3 text-2xl font-semibold text-zinc-100 sm:text-3xl lg:text-4xl">{profile?.full_name ?? 'Liameromero'}</h2>
            <p className="mt-5 max-w-xl text-base leading-relaxed text-zinc-300 sm:mt-6 sm:text-lg lg:text-xl">
              {profile?.summary ?? 'Desarrollador de software especializado en aplicaciones web Full Stack con Angular, Spring Boot y MySQL.'}
            </p>
            <p className="mt-4 max-w-xl text-base leading-relaxed text-zinc-300 sm:text-lg lg:text-xl">
              Tengo en progreso el titulo de Tecnico en Inteligencia Artificial en la Universidad de Hurlingham.
            </p>
          </div>
          ...
          <aside className="rounded-2xl border border-white/10 bg-white/[0.025] p-5 sm:p-6 md:mt-10 lg:mt-14 lg:p-7" aria-label="Formacion academica">
            <h3 className="text-xl font-medium leading-snug text-zinc-100 sm:text-2xl lg:text-3xl">Tecnico en Inteligencia Artificial</h3>
            <p className="mt-4 text-base leading-relaxed text-zinc-300 sm:text-lg lg:text-xl">
              Titulo en progreso en la Universidad de Hurlingham.
            </p>
          </aside>
        </div>
      </div>
